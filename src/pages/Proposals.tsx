...
export default function Proposals() {
  ...
  const processGeneration = async (formatType: 'pdf' | 'word', detailed?: boolean, detailedKM?: boolean) => {
    ...
    for (const proposal of ordersToProcess) {
      ...
      try {
        if (formatType === 'pdf') {
          generateCommercialProposalPDF(proposal, customer, selectedTechs, undefined, settings, detailed, detailedKM);
        } else {
          await generateCommercialProposalWord(proposal, customer, selectedTechs, undefined, settings, detailed, detailedKM);
        }
      } catch (error) {
